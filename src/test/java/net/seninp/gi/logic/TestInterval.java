...
public class TestInterval {
  ...
  /**
   * Test method for {@link net.seninp.gi.logic.Interval#Interval(int, int)}.
   */
  @Test
  ...
  /**
   * Test method for {@link net.seninp.gi.logic.Interval#Interval(int, int, double)}.
   */
  @Test
  ...
  /**
   * Test method for {@link net.seninp.gi.logic.Interval#intersects(net.seninp.gi.logic.Interval)}.
   */
  @Test
  ...
  /**
   * Test method for {@link net.seninp.gi.logic.Interval#contains(int)}.
   */
  @Test
